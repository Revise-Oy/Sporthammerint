...
//                    var media_type = '<img class="img-fluid" src="' + data.result.result.data[i].media_url + '" />';
                  ...
                  //  mesage=removedStr;
                    removedStrdict[data.result.result.data[i].id] = removedStr
                     ...
                     $for_data += '<div class="card border-0 mt-2"><div class="card-box-shadow">'+ media_type +'<div class="row"></div></div><div class="card-body pb-4"><div class="card-post-icon text-secondary"></div><div class="share-post pt-sm-3 pt-2 mt-sm-3 mt-2 border-top"><div class="row"><div class="col-12 px-0 text-center"><a class="d-inline-block py-1 text-primary w-100" href="' + data.result.result.data[i].permalink + '" title="View on Instagram" target="_blank"><small>View on Instagram</small></a></div></div></div></div></div>';
