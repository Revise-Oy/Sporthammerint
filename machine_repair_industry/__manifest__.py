...
{
    "name" : "Machine Repair Management in Odoo",
    "version" : "14.0.0.3",
    "depends" : ['base', 'sale', 'purchase', 'account', 'sale_stock', 'mail', 'product', 'stock','sale_management'],
    "author": "BrowseInfo",
    'price': 129.00,
    'summary': 'machine repair workshop product repair equipment repair service Repair Machine Diagnosis  repair workorder Operation Maintenance Repair order machine Maintenance and repair car repair computer Repair fleet repair car Maintenance auto-fleet service repair',
    'category': 'Industries',
    'currency': "EUR",
    "description": """
...
** Machine Repair ** Machine Diagnosis ** Machine Work Order **
...
* *After Workorder*: A Draft invoice is created and must be paid after workorder completion.
    ...
    -Laptop Repair, Computer servicing, Maintenance and Operation, Maintenance Repair, Service Industry. Computer Repair.Product Repair. Machine Maintenance, Repair and Maintenance. Product Repair management
        repair industry in odoo
    ...
    "data" :[
        ...
        'wizard/machine_repair_assign_to_head_tech_view.xml',
        'wizard/machine_diagnose_assign_to_technician_view.xml',
        'views/machine_repair_view.xml',
        'views/machine_repair_sequence.xml',
        'views/machine_diagnose_view.xml',
        # 'views/machine_diagnose_workflow.xml',
        # 'views/machine_repair_workflow.xml',
        'views/machine_workorder_sequence.xml',
        'views/machine_workorder_view.xml',
        # 'views/machine_workorder_workflow.xml',
        'views/custom_sale_view.xml',
        'report/machine_repair_label_view.xml',
        'report/machine_repair_label_menu.xml',
        'report/machine_repair_receipt_view.xml',
        'report/machine_repair_receipt_menu.xml',
        'report/machine_diagnostic_request_report_view.xml',
        'report/machine_diagnostic_request_report_menu.xml',
        'report/machine_diagnostic_result_report_view.xml',
        'report/machine_diagnostic_result_report_menu.xml',
        'report/machine_workorder_report_view.xml',
        'report/machine_workorder_report_menu.xml',
    ...
    "auto_install": False,
    "installable": True,
    "live_test_url":'https://youtu.be/P-ZXcINfxqg',
