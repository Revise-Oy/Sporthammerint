...
{
    "name" : "Website Machine Maintenance and Repair Management in Odoo",
    "version" : "14.0.0.2",
    "category" : "eCommerce",
    "depends" : ['website','website_sale', 'machine_repair_industry'],
    "author": "BrowseInfo",
    "summary": 'online machine repair online product repair website equipment repair service Repair website machine repair workorder website Maintenance Repair request machine Maintenance and repair computer Repair spare parts repair management material repair management',
    "description": """
...
* *After Workorder*: A Draft invoice is created and must be paid after workorder completion.
    ...
    "application": True,
    "installable": True,
    "live_test_url":'https://youtu.be/9lvFLvuifis',
